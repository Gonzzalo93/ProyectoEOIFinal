        ...
        <div class="container">
            ...
            <table class="table table-striped table-dark">
                <thead>
                 ...
                 <form action="/ProyectoWebFinal/ServletComprarArmadura" method="post">
                <tbody>
                    <tr id="espada">
                        <td><img src="imagenes/escudo1.png "></td>
                        <td class="tier1 ">Escudo básico: +100 HP +14 Defensa +2 Evasion </td>
                        <td><button type="submit" class="btn btn-warning txt " value="Escudo basico">Comprar (900g)</button></td>
                    </tr>
                    <tr>

                        <td><img src="imagenes/escudo2.png "></td>
                        <td class="tier2 ">Escudo robusto: +470 HP +33 Defensa +3 Evasion </td>
                        <td><button type="submit" class="btn btn-warning txt " value="Escudo robusto">Comprar (1.700g)</button></td>
                    </tr>
                    <tr>
                        <!-- <th scope="row ">3</th> -->
                        <td><img src="imagenes/escudo3.png "></td>
                        <td class="tier3 ">Escudo de Plata: +810 HP +33 Defensa +4 Evasion </td>
                        <td><button type="submit" class="btn btn-warning txt " value="Escudo de plata">Comprar (3.500g)</button></td>
                    </tr>
                    <tr>
                        <!-- <th scope="row ">3</th> -->
                        <td><img src="imagenes/escudo4.png "></td>
                        <td class="tier4 ">Gran Escudo: +1300 HP +68 Defensa +4 Evasion </td>
                        <td><button type="submit" class="btn btn-warning txt " value="Gran escudo">Comprar (5.100g)</button></td>
                    </tr>
                    <tr>
                        <!-- <th scope="row ">3</th> -->
