 ...
 * @author migue
 */
public class Piso15 extends javax.swing.JFrame {
...
//datos personaje
    ...
    public Piso15() {
        ...
        enemigo.setNombre("Deliz");
        enemigo.setElemento("Oscuridad");
        enemigo.setMaxHp(78260);
        enemigo.setHp(78260);
        enemigo.setNivel(11);
        enemigo.setAtq(946);
        enemigo.setDef(870);
        enemigo.setEva(38);
        enemigo.setExp(4270);
        enemigo.setDinero(5190);
        enemigo.setTcrit(63);
        enemigo.setDcrit(200);
    }
