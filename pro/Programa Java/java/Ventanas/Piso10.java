 ...
 * @author migue
 */
public class Piso10 extends javax.swing.JFrame {
...
//datos personaje
    ...
    public Piso10() {
        ...
        //CREAMOS ENEMIGOS
        enemigo.setNombre("Zolung");
        enemigo.setElemento("Electrico");
        enemigo.setMaxHp(28430);
        enemigo.setHp(28430);
        enemigo.setNivel(8);
        enemigo.setAtq(540);
        enemigo.setDef(460);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PISO 10 - ZOLUNG");
  ...
  //METODOS
    ...
    public void seguimiento(int causado, int recibido, int curado, boolean extra, boolean mp, boolean elem){
        ...
        if(causado > 0 && curado == 0 && extra == false){
          ...
          //Solo te curas
        }else  if(causado > 0 && curado == 0 && elem == true && mp == true){
          Consola.setText(
