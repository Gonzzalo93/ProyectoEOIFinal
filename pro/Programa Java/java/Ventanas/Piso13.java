 ...
 * @author migue
 */
public class Piso13 extends javax.swing.JFrame {
...
//datos personaje
    ...
    public Piso13() {
        ...
        //CREAMOS ENEMIGOS
        enemigo.setNombre("Leviathan");
        enemigo.setElemento("Agua");
        enemigo.setMaxHp(25490);
        enemigo.setHp(25490);
        enemigo.setNivel(9);
        enemigo.setAtq(572);
        enemigo.setDef(510);
        enemigo.setEva(24);
        enemigo.setExp(2140);
        enemigo.setDinero(2080);
        enemigo.setTcrit(7);
        enemigo.setDcrit(120);
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PISO 13 - LEVIATHAN");
