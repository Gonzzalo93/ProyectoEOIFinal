 ...
 * @author migue
 */
public class Piso8 extends javax.swing.JFrame {
...
//datos personaje
    ...
    public Piso8() {
       initComponents();
        ...
        //CREAMOS ENEMIGOS
        enemigo.setNombre("Elemental de agua");
        enemigo.setElemento("Agua");
        enemigo.setMaxHp(8700);
        enemigo.setHp(8700);
        enemigo.setNivel(6);
        enemigo.setAtq(220);
        enemigo.setDef(170);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PISO 8 - ELEMENTAL DE AGUA");
    ...
    private void AtacarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AtacarActionPerformed
        ...
        seguimiento(causado, recibido, 0, false, false, false);
    ...
    private void Hab2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Hab2ActionPerformed
        ...
        if(jugador.getClase().equals("Guerrero")){
            if(jugador.getMp() - 18 >= 0){
                ...
                mp = true;
            if(enemigo.getMaxHp() * 0.3  <= enemigo.getHp()){//retocar
                double bono = causado * 0.5;
                int extra = (int) bono;
                causado = causado + (extra);
                dmgextra = true;
